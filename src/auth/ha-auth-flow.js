    ...
    return html`
      ...
      <form>
        ...
        <template is="dom-if" if='[[_equals(_state, "step")]]'>
          ...
          <div class="action">
            <mwc-button raised block on-click="_handleSubmit" class="wide"
      ...
      <div class="links">
        <a href="#">
            <img src="/static/icons/ic_info.png" alt="information" class="information-icon">
            Thông tin
        </a>
        <a href="#"><ha-icon icon="hass:help-circle"></ha-icon>Trợ giúp</a>
      </div>
    `
  }
